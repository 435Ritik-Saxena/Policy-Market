...
public class SecurityConfig {
	...
	SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		.requestMatchers("/agentapp/**").permitAll().requestMatchers("/planapp/**").permitAll()
		.requestMatchers("/paymentapp/**").permitAll().requestMatchers("/claimapp/**").permitAll()
		.requestMatchers("/schemeapp/**").permitAll()
		.requestMatchers("/fileapp/**").permitAll()
		.requestMatchers("/schemefileapp/**").permitAll()
		.requestMatchers("/policyapp/**").permitAll().requestMatchers("/queryapp/**").permitAll()
