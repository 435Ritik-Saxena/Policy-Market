...
public class PolicyServiceImpl implements PolicyService{
	...
	public Page<AllPolicyDto> getAllPolicies(int customerid, int pageno, int pagesize) {
		//Customer customer = customerRepo.findByCustomer_Id(customerid);
	...
	public List<PremiumDto> getPremiums(int policynumber) {
        ...
        if(policy.getPremiumtype()==PremiumType.Yearly) {
        	System.out.println("gjasdf");
        	count = (years * 12)/12;
        	System.out.println("Count" +count);
        	for(int i=0; i<count; i++) {
        		System.out.println("JGHFGKFGK");
        		...
        		//System.out.println(premium.getDate() + premium.getStatus() + premium.getPay());
        		payments--;
        		premiums.add(premium);
        	}
        }
        else if(policy.getPremiumtype()==PremiumType.Monthly) {
        	System.out.println("sdfgdfgdsf");
        	count = (years * 12);
        	for(int i=0; i<count; i++) {
        		PremiumDto premium = new PremiumDto();
        ...
        System.out.println("siiiizzzeeee"+premiums.size());
		return premiums;
	}
